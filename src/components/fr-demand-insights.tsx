...
export function FrDemandInsights({
  ...
  const themes = useMemo(() => themeClusters(rows), [rows]);
      ...
      <Card className="lg:col-span-2">
        <CardHeader>
          ...
          <span className="text-[11px] text-fg-subtle">
            {themes.length} {themes.length === 1 ? "theme" : "themes"} across open FRs
          </span>
        </CardHeader>
          ...
          {themes.length === 0 ? (
            ...
            <div className="overflow-x-auto scroll-thin">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {themes.map((t) => (
                    <tr key={t.theme} className="border-b border-border/50 align-top">
                      <td className="px-4 py-2 text-fg font-medium max-w-[280px] truncate">
                        {t.theme}
                      </td>
      ...
      <Card>
        ...
        <CardBody className="space-y-3">
          <div className="flex items-end gap-2">
            ...
            <div className="text-[11px] text-fg-subtle pb-0.5">owned or slotted</div>
          </div>
          ...
          <p className="text-xs text-fg-muted">
            ...
            {coverage.untriaged > 0 && " — no owner and not sprinted"}
          </p>
